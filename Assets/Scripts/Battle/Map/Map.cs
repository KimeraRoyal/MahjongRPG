...
namespace Map
{
    public class Map : MonoBehaviour
    {
        ...
        public bool MoveFeature(Feature _feature, Vector2Int _position)
        {
            if(HasFeatureAt(_position)) { return false; }
            m_features[_position.x, _position.y] = _feature;
            return true;
        }
        ...
        private void InitialiseMap()
        {
            ...
            m_features = new Feature[m_size.x, m_size.y];
        ...
        {
            if (_position.x < 0 || _position.x >= m_size.x || _position.y < 0 || _position.y >= m_size.y) { return null; }
            return m_features[_position.x, _position.y];
        }
